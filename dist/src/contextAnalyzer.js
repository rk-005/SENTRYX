...
class ContextAnalyzer {
    analyzeMultiStepAttacks(currentPrompt, history) {
    ...
    generateReason(detectedEntities, keywordFindings, contextAttackType, escalationFactor) {
        const reasons = [];
